...
var wtmt_root = 'http://chatdemo/'; // ex : http://www.mywebsite/
...
styleA.href = wtmt_root+"chat-app/assets/css/chatApp.css";
...
styleB.href = wtmt_root+"chat-app/assets/css/colors_front.css";
...
if (!window.jQuery) {
    ...
    script.src = wtmt_root+"chat-app/assets/js/jquery-1.11.1.min.js";
...
function loadChatScript() {
    ...
    scriptM.src = wtmt_root+"chat-app/assets/js/jquery-migrate-1.2.1.min.js";
    document.getElementsByTagName("head")[0].appendChild(scriptM);


    var scriptC = document.createElement("script");
    scriptC.type = "text/javascript";
    scriptC.src = wtmt_root+"chat-app/assets/js/chatApp.js";
