...
function vcht_initTimerLife() {
  ...
  console.log('DONE: vcht_initTimerLife()');
}
...
function vcht_initCheckTimer(){
    ...
    console.log('DONE: vcht_initCheckTimer()');
...
function vcht_initBounce() {
    ...
    console.log('DONE: vcht_initBounce()');
...
function vcht_initTimer() {
    if (vcht_isChatting) {
        ...
        console.log('GOOD: operator is ACTIVE');
        ...
        vcht_timer = setTimeout(function () {
            jQuery.ajax({
                ...
                success: function (repS) {
                    console.log('SUCCESS: clientAjax.php post action vcht_check_user_chat');
                    if (repS.indexOf('}') > 0) {
                    ...
                    console.log('INIT: vcht_initTimer() INNER');
                    vcht_initTimer();

                },
                error: function() {
                    console.log('ERROR: clientAjax.php post action vcht_check_user_chat');
                }
            });
        }, 1000);
    } else {
        console.log('BAD: operator is inACTIVE');
    }

    console.log('DONE: vcht_initTimer()');
...
function vcht_initChat() {
    ...
    console.log('DONE: vcht_initChat()');
}
...
function vcht_operatorSay(msg, recover) {
    ...
    if (!recover) {
     ...
     console.log('DONE: vcht_operatorSay(msg, recover)');
}
...
function vcht_sendMessage() {
    ...
    console.log('DONE: vcht_sendMessage()');
